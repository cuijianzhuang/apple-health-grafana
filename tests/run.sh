...
for service in test-ingester-std test-ingester-no-routes-uppercase test-ingester-malformed-xml test-ingester-malformed-xml-2 test-ingester-cn test-ingester-ita
do
